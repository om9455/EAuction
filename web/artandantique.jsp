                ...
                <div class="col-lg-12">
                    ...
                    <div class="container-fluid pt-5">
                        <div class="text-center mb-4">
                            <h2 class="section-title px-5"><span class="px-2">Art And Antiques</span></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row px-xl-5 pb-3">
                <%
                    ...
                    try {
                        ...
                        String sql = "SELECT item_id, item_name, item_img, item_bprice, start_time, end_time FROM item WHERE item_category='art and antique'";
