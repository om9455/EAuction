                    ...
                    <% 
                        ...
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                //out.println("<td class='img-container'><img src='" + rs.getString("item_img") + "' alt='Item Image'></td>");                                       out.println("<td>" + rs.getString("item_bprice") + "</td>");
                                out.println("<td>" + rs.getString("item_bprice") + "</td>");
